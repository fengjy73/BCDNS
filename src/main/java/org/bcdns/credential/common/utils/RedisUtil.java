...
//    public String publicKey;
    ...
    public void setPool() {
        try {
            if (pool == null) {
              /*  String ip = Config.getProperty("redis.host");
                int port = Integer.parseInt(Config.getProperty("redis.port"));
                String encryptPassword = Config.getProperty("redis.password");
                String publicKey = Config.getProperty("redis.publicKey");*/
    ...
    public static String getValueByField(String key, String Field) {
        Jedis jedis = null;
        try {
            jedis = pool.getResource();
        } catch (Exception e) {
        ...
        JSONObject vJSON = JSON.parseObject(jedis.get(key));
        return vJSON.getString(Field);
    }
